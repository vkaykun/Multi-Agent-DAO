...
export interface Plugin {
    ...
    /** Optional character load callback */
    onCharacterLoad?: (runtime: IAgentRuntime, character: Character) => Promise<void>;
}
...
export type Character = {
    ...
    agentConfig?: {
        ...
        type: "PROPOSAL" | "TREASURY" | "STRATEGY";
...
export interface IAgentRuntime {
    // Properties
    agentId: UUID;
    agentType: "PROPOSAL" | "TREASURY" | "STRATEGY" | "USER";
    serverUrl: string;
